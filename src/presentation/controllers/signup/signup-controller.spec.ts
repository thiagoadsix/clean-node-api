...
describe('SignUp Controller', () => {
  test('Should return 500 if AddAccount throws', async () => {
    ...
    expect(httpResponse).toEqual(serverError(new ServerError('error stack trace')))
  })
  ...
  test('Should call AddAccount with correct values', async () => {
    ...
    expect(addSpy).toHaveBeenCalledWith({ name: 'any_name', email: 'any_email@email.com', password: 'any_password' })
  })
